            ...
            <div x-show="fullscreenModal" x-transition:enter="transition ease-out duration-300"
                ...
                <!-- <div
                    ...
                    <a href="#_"
                        ...
                        <span
                            class="flex opacity-90 group-hover:scale-150 group-hover:opacity-100 items-center h-full group-hover:-rotate-6 ease-out duration-500 px-0.5 py-px ml-2 -translate-x-px text-[0.6rem] font-bold leading-none border-[2px] rounded border-white -translate-y-px">VOLHUB</span>
                    </a>
