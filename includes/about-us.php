<div class="max-w-6xl px-12 mx-auto text-center">
    <div class="space-y-12 md:text-center">
        <div class="max-w-3xl mb-20 space-y-5 sm:mx-auto sm:space-y-4">
            <h2 class="relative text-white font-extrabold tracking-tight sm:text-5xl">About Us</h2>
            <p class="text-xl text-gray-300">We take pride in the people we work with. This is because we all
...
<!-- Card 1 -->
<div class="grid grid-cols-1 gap-0 sm:grid-cols-1 lg:grid-cols-1">
    <div class="w-full border border-gray-200 rounded-lg shadow-sm">
        ...
        <div class="flex flex-col items-center justify-center p-10">
            ...
            <h2 class="text-white font-medium">Akash A</h2>
            <p class="font-medium text-blue-500">CEO and Founder</p>
            <p class="text-gray-400">The one who made the decision to build VolunHub.</p>
        </div>
