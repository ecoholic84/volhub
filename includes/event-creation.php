...
" x-cloak>
                                            ...
                                            <div class="relative w-full">
                                                <input x-ref="datePickerInput" type="text" id="event_datetime"
                                                    ...
                                                    class="flex w-full h-10 px-3 py-2 text-sm border-neutral-700 bg-neutral-800 rounded-md focus:ring focus:outline-none text-neutral-100 disabled:cursor-not-allowed disabled:opacity-50"
