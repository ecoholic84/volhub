...
<body class="flex items-center justify-center h-screen bg-gray-50">
    <div class="relative w-full max-w-sm bg-white shadow-lg rounded-lg p-6">
        <div x-data="{
        tabSelected: 1,
        tabId: $id('tabs'),
        ...
        tabContentActive(tabContent){
            ...
            <div class="relative w-full mt-4">
                <div :id="$id(tabId + '-content-1')" x-show="tabContentActive($el)" x-cloak class="relative">
                        ...
                        <form action="signup-handler.php" method="POST">
                            <div class="border rounded-lg shadow-sm bg-card text-neutral-900">
                                ...
                                <div class="p-6 pt-0 space-y-2">
                                    <div class="space-y-1">
                                        <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for="fullname">Name</label>
                                        <input type="text" name="fullname" placeholder="Richard Hendricks" id="fullname" value=""
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <input type="text" name="username" placeholder="ecoholic" id="username" value=""
                                            class="flex w-full h-10 px-3 py-2 text-sm bg-white border rounded-md peer border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-400 disabled:cursor-not-allowed disabled:opacity-50" />
                                    </div>
                                    <div class="space-y-1">
                                        <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for="email">Email</label>
                                        <input type="text" name="email" placeholder="mail@example.com" id="email" value=""
                                            class="flex w-full h-10 px-3 py-2 text-sm bg-white border rounded-md peer border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-400 disabled:cursor-not-allowed disabled:opacity-50" />
                                    </div>
                                    <div class="space-y-1">
                                        <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for="pwd">Password</label>
                                        <input type="password" name="pwd" placeholder="50uR6O2rJMA64fF%r49Kze&I*@!oY66*" id="pwd" value=""
                                            class="flex w-full h-10 px-3 py-2 text-sm bg-white border rounded-md peer border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-400 disabled:cursor-not-allowed disabled:opacity-50" />
                                    </div>
                                    <div class="space-y-1">
                                        <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for="pwdrepeat">Repeat Password</label>
                                        <input type="password" name="pwdrepeat" placeholder="Repeat the password" id="pwdrepeat" value=""
                                            class="flex w-full h-10 px-3 py-2 text-sm bg-white border rounded-md peer border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-400 disabled:cursor-not-allowed disabled:opacity-50" />
                                    </div>
                                </div>
                ...
                <div :id="$id(tabId + '-content-2')" x-show="tabContentActive($el)" x-cloak class="relative">
                    ...
                    <div class="border rounded-lg shadow-sm bg-card text-neutral-900">
                        ...
                        <section class="login-form">
                            <form action="login-handler.php" method="POST">
                                <div class="p-6 pt-0 space-y-2">
                                    <div class="space-y-1">
                                        <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for="email">Username/Email</label>
                                        <input type="text" name="email" placeholder="mail@example.com" id="email" value=""
                                            class="flex w-full h-10 px-3 py-2 text-sm bg-white border rounded-md peer border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-400 disabled:cursor-not-allowed disabled:opacity-50" />
                                    </div>
                                    <div class="space-y-1">
                                        <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for="pwd">Password</label>
                                        <input type="password" name="pwd" placeholder="50uR6O2rJMA64fF%r49Kze&I*@!oY66*" id="pwd" value=""
                                            classHere is the continuation and completion of the HTML code to make your login/signup page into a floating card:
...
```html
                                ...
                                <div class="flex items-center justify-between p-6 pt-0">
                                    ...
                                    <a href="#" class="text-sm text-neutral-600 hover:underline">Forgot Password?</a>
                                </div>
                            </form>
                        </section>
                    </div>
